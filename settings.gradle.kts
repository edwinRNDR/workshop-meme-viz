...
rootProject.name = "workshop-meme-viz"
...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            version("openrndr", if (openrndrUseSnapshot) "0.5.1-SNAPSHOT" else "0.4.2-rc.1")
            version("orx", if (orxUseSnapshot) "0.5.1-SNAPSHOT" else "0.4.2-rc.1")
